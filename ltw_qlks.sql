CREATE DATABASE  IF NOT EXISTS `ltw_qlks` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ltw_qlks`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: localhost    Database: ltw_qlks
-- ------------------------------------------------------
...
CREATE TABLE `booking` (
  ...
  CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`id_HD`) REFERENCES `hoa_don` (`id_HD`),
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`id_phong`) REFERENCES `phong` (`id_phong`)
...
CREATE TABLE `loai_phong` (
  ...
  `ten_loai_phong` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
-- Dump completed on 2021-11-09 22:40:00
